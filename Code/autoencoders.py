...
class DAE:
    def __init__(self, input_dim, batch_size, latent_dim):
        ...
        encoded = BatchNormalization()(encoded) # Comment out this to remove batch normalization
        ...
        decoded = BatchNormalization()(decoded) # Comment out this to remove batch normalization
        ...
        decoded = Dense(
            self.input_dim,
            activation='sigmoid', # Comment out this and 
            #activation='linear', # remove the # from this to make the linear output
            kernel_initializer='glorot_uniform')(decoded)
